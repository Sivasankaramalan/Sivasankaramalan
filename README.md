...
- 🚀 Product engineering: from idea to shipped platform
- 🧠 Native AI engineer: Cursor, MCP workflows, GitHub Copilot (certified)
- 🧱 Systems ownership: architecture, reliability, automation, observability
- 📌 Program leadership: roadmap execution, release governance, stakeholder alignment
- 🌍 Building GoLocally.in (parent platform) and Local.Ally (community + travel tech)
...
![RestAssured](https://img.shields.io/badge/REST%20Assured-1C1C1C?style=for-the-badge&logo=java&logoColor=white)
