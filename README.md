...
## What I’m focused on
- Building scalable product experiences (mobile first)
- AI assisted engineering workflows (test gen, refactoring, RCA automation)
- Engineering systems that are resilient, observable, and easy to evolve
- Strong delivery orchestration with predictable releases

---

## Core strengths
### Product + Engineering
- End to end product development (problem → solution → execution)
- Platform thinking, system design, and architectural tradeoffs
- API design, integrations, reliability engineering

### AI Engineering (Native)
- Cursor driven workflows for coding, refactoring, and system design
- MCP style toolchains to automate engineering tasks
- GitHub Copilot certified, used for velocity with guardrails
- AI enabled documentation, test planning, and operational playbooks

### Program + Delivery
- Roadmap planning and milestone execution
- Cross functional alignment (engineering, product, business)
